...
public class Stormite_Old : MonoBehaviour
{
    ...
    // What state the enemy is in, 0 = aiming, 1 = charging
    private int state;
    private float timer;
    private int health;
    ...
    void Attack()
    {
        ...
        bullet.GetComponent<BulletStats>().speedMultiplier = bulletSpeedMultiplier;
    ...
    void SpreadAttack()
    {
        ...
        bullet1.GetComponent<BulletStats>().speedMultiplier = bulletSpeedMultiplier;
        bullet2.GetComponent<BulletStats>().speedMultiplier = bulletSpeedMultiplier;
        bullet3.GetComponent<BulletStats>().speedMultiplier = bulletSpeedMultiplier;
